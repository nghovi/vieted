...
export const grade9EnglishChapters: EnglishChapter[] = [
  {
    ...
    questionSets: [
      ...
      set("e1-set-4", "Bộ chẩn đoán", [
        q("e1s4q1", "Choose the best word: A place where people can play sports and join activities is a community ______.", ["centre", "forest", "island", "bridge"], 0, "A community centre is a local place for activities and services."),
        q("e1s4q2", "Which sentence is correct?", ["There are three parks in my neighbourhood.", "There is three parks in my neighbourhood.", "There are a park in my neighbourhood.", "There park are three in my neighbourhood."], 0, "Use 'There are' with plural nouns such as 'three parks'."),
        q("e1s4q3", "Choose the correct preposition: The pharmacy is ______ the bank and the bakery.", ["between", "for", "during", "through"], 0, "Use 'between' when one place is in the middle of two others."),
        q("e1s4q4", "Which answer best fits the question 'Why do you like your neighbourhood?'", ["Because it is safe and friendly.", "It is next to the school.", "I go there by bike.", "At seven o'clock."], 0, "A 'Why' question needs a reason, often beginning with 'Because'."),
        q("e1s4q5", "The word 'helpful' is closest in meaning to ______.", ["ready to support others", "very noisy", "full of litter", "hard to find"], 0, "Helpful describes a person who likes to support or assist others."),
        q("e1s4q6", "Which activity is NOT good for the local community?", ["throwing rubbish on the street", "visiting old neighbours", "joining a clean-up day", "planting trees"], 0, "Throwing rubbish on the street harms the local environment."),
        q("e1s4q7", "Choose the correct sentence pattern.", ["My father usually buys fruit at the market.", "My father usually buy fruit at the market.", "My father buying usually fruit at the market.", "My father buys usually fruit at the market."], 0, "With 'my father', the verb in the present simple should be 'buys'."),
        q("e1s4q8", "Which title best matches a short text about markets, clinics, libraries, and parks?", ["Places in my community", "My school timetable", "A family picnic", "Weather in summer"], 0, "The title should match the main topic of community places."),
        q("e1s4q9", "A person who makes bread and cakes is a ______.", ["baker", "farmer", "pilot", "nurse"], 0, "A baker makes or sells bread and cakes in a bakery."),
        q("e1s4q10", "Which sentence shows a regular habit?", ["We often visit the community centre on Sundays.", "We are visiting the community centre now.", "We visited the community centre yesterday.", "We will visit the community centre tomorrow."], 0, "The adverb 'often' shows a repeated habit in the present simple."),
      ]),
      set("e1-set-5", "Bộ ôn tập tổng hợp", [
        q("e1s5q1", "Choose the best response: 'Where is the post office?'", ["It is opposite the park.", "Because it is useful.", "It opens on Sunday.", "I like it very much."], 0, "A 'Where' question needs a location answer."),
        q("e1s5q2", "Which sentence is grammatically correct?", ["The library is quieter than the market.", "The library is more quiet than the market.", "The library quieter than the market.", "The library is quietest than the market."], 0, "For short adjectives like 'quiet', the comparative form is 'quieter than'."),
        q("e1s5q3", "Choose the correct preposition: Many students meet ______ the community centre after school.", ["at", "between", "during to", "under"], 0, "We usually say 'meet at' a place."),
        q("e1s5q4", "Which word best completes the sentence? 'Our neighbourhood is very ______ because people always greet each other warmly.'", ["friendly", "crowded", "dangerous", "empty"], 0, "Friendly describes a place where people are kind and welcoming."),
        q("e1s5q5", "Which question matches the answer 'Students can collect rubbish and plant flowers'?", ["How can students help the local community?", "Where do students study after school?", "When does the library open?", "Who is the oldest neighbour?"], 0, "The answer explains actions students can do to help the community."),
        q("e1s5q6", "The word 'nearby' is closest in meaning to ______.", ["not far away", "very expensive", "under the road", "full of people"], 0, "Nearby means close in distance."),
        q("e1s5q7", "Choose the correct sentence.", ["There is a museum near the bus station.", "There are a museum near the bus station.", "There is museum near the bus station.", "There museum is near the bus station."], 0, "Use 'There is' with a singular noun like 'a museum'."),
        q("e1s5q8", "Which sentence gives a reason?", ["I like my area because it is clean and safe.", "My area is near the river.", "There is a clinic in my area.", "My neighbours are chatting outside."], 0, "The conjunction 'because' introduces a reason."),
        q("e1s5q9", "A community clean-up is a good way to keep the streets ______.", ["clean", "late", "broken", "hungry"], 0, "A clean-up activity helps make the streets clean."),
        q("e1s5q10", "What is the main idea of a good local community?", ["People support one another and take care of shared places.", "Everyone stays at home all day.", "Only large cities have useful services.", "A community is only about buildings."], 0, "A strong local community is built by helpful people and shared responsibility."),
      ]),
    ],
  },
  {
