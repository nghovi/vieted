...
import type { HistoryChapterEvaluation, HistoryScorePoint } from "@/lib/db";
import { TrendChartDialog, TrendChartTrigger } from "../trend-chart-dialog";

type Props = {
  chapterId: string;
  setResults: HistoryChapterEvaluation["setResults"];
};
...
export function ReviewSetList({ chapterId, setResults }: Props) {
