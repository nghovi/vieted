...
import type { HistoryScorePoint, MathQuestionSetProgress } from "@/lib/db";
import {
  TrendChartDialog,
  TrendChartTrigger,
...
export function MathTestSetList({ chapterId, sets }: Props) {
        ...
        {sets.map((set) => (
          <article key={set.setId} className="feature-card">
            ...
            <div className="inline-actions">
              <Link href={`/math/grade-9/${chapterId}/test/${set.setId}`} className="primary-link">
