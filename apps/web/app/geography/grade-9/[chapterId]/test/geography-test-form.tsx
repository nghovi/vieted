...
import type { GeographyQuestionSetAttemptResult, HistoryScorePoint } from "@/lib/db";
...
export function GeographyTestForm({
  chapterId,
  setId,
  setTitle,
  questions,
  ...
  const [result, setResult] = useState<GeographyQuestionSetAttemptResult | null>(null);
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const response = await fetch("/api/geography/grade-9/test/submit", {
      method: "POST",
    ...
    const data = (await response.json()) as {
      error?: string;
      result?: GeographyQuestionSetAttemptResult;
    };
        ...
        <section className="content-section">
          ...
          <div className="feature-card">
            <div className="test-toolbar">
              ...
              <span className="test-progress-badge">{result.scorePercent}% ở lần làm mới nhất</span>
            </div>
          ...
          <div className="feature-card chapter-feature">
            <div className="test-toolbar">
              ...
              <div className="inline-actions">
                <button type="button" className="primary-link action-button" onClick={() => { setAnswers({}); setErrorMessage(null); setResult(null); }}>
                  Làm lại bộ này
                </button>
