...
import type { GeographyChapterEvaluation, HistoryScorePoint } from "@/lib/db";
import {
  TrendChartDialog,
  TrendChartTrigger,
...
type Props = {
  chapterId: string;
  setResults: GeographyChapterEvaluation["setResults"];
};
...
export function GeographyReviewSetList({ chapterId, setResults }: Props) {
        ...
        {setResults.map((setResult) => (
          <article key={setResult.setId} className="feature-card">
            ...
            <div className="inline-actions">
              <Link
                href={`/geography/grade-9/${chapterId}/test/${setResult.setId}`}
